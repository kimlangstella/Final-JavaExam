...
public class exercise2 {
    public static void main(String[] args) {
        Customer c1 = new Customer("Kimlang");
        Customer c2 = new Customer("Stella");
        Customer c3 = new Customer("Ling Er");
        Customer c4 = new Customer("Pitur");

        c2.setCustomerType("Premium");
        c3.setCustomerType("Gold");
        c4.setCustomerType("Silver");

        Sale sale_c1 = new Sale(c1, "2024-02-22");
        Sale sale_c2 = new Sale(c2, "2024-02-23");
        Sale sale_c3 = new Sale(c3, "2024-02-24");
        Sale sale_c4 = new Sale(c4, "2024-02-25");
